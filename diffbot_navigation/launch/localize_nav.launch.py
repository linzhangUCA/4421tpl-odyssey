...
def generate_launch_description():
    ...
    slam_config_path = package_path / 'config/slam_localize_params.yaml'
    nav_config_path = package_path / 'config/nav2_params.yaml'
    ...
    launch_simulation = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            str(package_path / 'launch/simulate.launch.py')
        )
    )
